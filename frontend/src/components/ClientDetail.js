            ...
            <div className="p-6">
              ...
              {activeTab === 'notes' && (
                <div className="h-96 flex flex-col">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-medium text-gray-900">Ghi chú & Chat ({chatMessages.length})</h3>
                    <span className="text-sm text-gray-500">
                      Lịch sử trao đổi về khách hàng
                    </span>
                  </div>
                  ...
                  <div className="flex-1 overflow-y-auto border rounded-lg p-4 mb-4 bg-gray-50">
                    {chatMessages.length === 0 ? (
                      <div className="text-center py-8">
                        ...
                        <p className="text-gray-400 text-sm mt-1">Bắt đầu cuộc trò chuyện về khách hàng này</p>
                      </div>
                    ) : (
